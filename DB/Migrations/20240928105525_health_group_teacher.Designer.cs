...
namespace DB.Migrations
{
    ...
    [Migration("20240928105525_health_group_teacher")]
    partial class health_group_teacher
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DB.Tables.StudentEntity", b =>
                {
                    ...
                    b.Property<string>("HealthGroupTeacherId")
                        .HasMaxLength(36)
                        .HasColumnType("character varying(36)");
                    ...
                    b.HasIndex("HealthGroupTeacherId");
            ...
            modelBuilder.Entity("DB.Tables.StudentEntity", b =>
                {
                    ...
                    b.HasOne("DB.Tables.TeacherEntity", "HealthGroupTeacher")
                        .WithMany()
                        .HasForeignKey("HealthGroupTeacherId");

                    b.Navigation("Group");

                    b.Navigation("HealthGroupTeacher");
