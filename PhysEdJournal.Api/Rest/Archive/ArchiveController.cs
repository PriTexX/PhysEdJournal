...
public static class ArchiveController
{
    public static void MapEndpoints(IEndpointRouteBuilder router)
    {
        ...
        router
            .MapPost("/archive-student", ArchiveStudent)
            .AddValidation<ArchiveStudentRequest, ArchiveStudentRequest.Validator>();
        router
            .MapPost("/unarchive-student", UnArchiveStudent)
            .AddValidation<UnArchiveStudentRequest, UnArchiveStudentRequest.Validator>();
    }
    ...
    private static async Task<IResult> UnArchiveStudent(
        string studentGuid,
        string semesterName,
