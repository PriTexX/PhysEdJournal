...
public static class PermissionConstants
{
    ...
    public const TeacherPermissions FOR_ONLY_ADMIN_USE_PERMISSIONS = TeacherPermissions.AdminAccess | TeacherPermissions.SuperUser;
    public const TeacherPermissions FOR_ONLY_SUPERUSER_USE_PERMISSIONS = TeacherPermissions.SuperUser;
}