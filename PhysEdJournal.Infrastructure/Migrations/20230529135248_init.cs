        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisitValue = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchivedStudents", x => new { x.StudentGuid, x.SemesterName });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "text", nullable: false),
                    GroupNumber = table.Column<string>(type: "text", nullable: false),
                    HasDebtFromPreviousSemester = table.Column<bool>(type: "boolean", nullable: false),
                    ArchivedVisitValue = table.Column<double>(type: "double precision", nullable: false),
