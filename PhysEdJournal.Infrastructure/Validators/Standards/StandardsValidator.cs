...
{
    public void ValidateStudentPointsForStandardsAndThrow(
        int pointsToAdd,
        int pointsForStandards,
        string studentGuid
    )
    {
        var validationResult = ValidateStudentPointsForStandards(
            pointsToAdd,
            pointsForStandards,
            studentGuid
        );
    ...
    public LanguageExt.Common.Result<bool> ValidateStudentPointsForStandards(
        int pointsToAdd,
        int pointsForStandards,
        string studentGuid
    )
    {
        if (pointsForStandards == MAX_POINTS_FOR_STANDARDS)
        {
            return new LanguageExt.Common.Result<bool>(
                new OverAbundanceOfPointsForStudentException(studentGuid)
            );
        }
