...
public static class Cfg
{
    ...
    public static int MinTotalPointsToAddStandardsForCoursesHigherThan1 { get; private set; } = 40;
    public static int MinTotalPointsToAddStandards { get; private set; } = 30;
